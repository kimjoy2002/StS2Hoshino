...
public class ShieldAttack() : StS2HoshinoCard(1, CardType.Attack, CardRarity.Common, TargetType.AnyEnemy)
{
    ...
    protected override async Task OnHoshinoPlay(PlayerChoiceContext choiceContext, CardPlay play)
    {
        ...
        await DamageCmd.Attack(base.DynamicVars.CalculatedDamage).FromCardCompat(this, play).WithAttackerAnim("Swing", 0.15f).Targeting(play.Target).Execute(choiceContext);
    }
